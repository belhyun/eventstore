  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved coupon as @coupon" do
        ...
        post :create, {:coupon => { "link" => "invalid value" }}, valid_session
        expect(assigns(:coupon)).to be_a_new(Coupon)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested coupon" do
        ...
        expect_any_instance_of(Coupon).to receive(:update).with({ "link" => "MyText" })
        put :update, {:id => coupon.to_param, :coupon => { "link" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the coupon as @coupon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Coupon.any_instance.stub(:save).and_return(false)
        put :update, {:id => coupon.to_param, :coupon => { "link" => "invalid value" }}, valid_session
        expect(assigns(:coupon)).to eq(coupon)
      end
